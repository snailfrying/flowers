...
- ✅ 双语对照不影响阅读体验
820:
821: ### 8.3 Phase 2.5: 圈选翻译功能（预计 3 天）
822:
823: **目标**：实现 PDF 区域选择翻译。
824:
825: **任务清单**：
826:
827: | 任务 | 预计工时 | 优先级 |
828: |------|----------|--------|
829: | 实现 SelectionOverlay 交互层 (Canvas/Div) | 4h | P1 |
830: | 实现坐标映射与 Span 碰撞检测算法 | 6h | P1 |
831: | 集成翻译服务与 Popover UI | 4h | P1 |
832: | 处理跨列/复杂排版的文本排序与合并 | 4h | P2 |
833:
834: **验收标准**：
835:
836: - ✅ 鼠标圈选流畅，视觉反馈清晰
